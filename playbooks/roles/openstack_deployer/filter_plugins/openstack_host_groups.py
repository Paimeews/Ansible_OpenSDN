...
class FilterModule(object):
    ...
    openstack_role_subgroups = {
        ...
        "common": ['control', 'network', 'compute', 'storage', 'monitoring'],

        # Common
        "cron": ["common"],
        "fluentd": ["common"],
        "kolla-logs": ["common"],
        "kolla-toolbox": ["common"],
        ...
        "letsencrypt-webserver": ["letsencrypt"],
        "letsencrypt-lego": ["letsencrypt"],
        "magnum-api": ["magnum"],
        ...
        "neutron-ovn-metadata-agent": ["compute", "network"],
        "neutron-ovn-agent": ["compute"],
        ...
        "ovn-controller-compute": ["compute"],
        "ovn-controller-network": ["network"],
        "ovn-database": ["control"],
        "ovn-northd": ["ovn-database"],
        "ovn-nb-db": ["ovn-database"],
        "ovn-sb-db": ["ovn-database"],
        "panko-api": ["panko"],
        "panko": ["control"],
        "placement-api": ["placement"],
        "placement": ["control"],
        "prometheus": ["monitoring"],
        "prometheus-node-exporter": ["monitoring", "control", "compute", "network", "storage"],
        "prometheus-mysqld-exporter": ["mariadb"],
        "prometheus-haproxy-exporter": ["haproxy"],
        "prometheus-memcached-exporter": ["memcached"],
        "prometheus-cadvisor": ["monitoring", "control", "compute", "network", "storage"],
        "prometheus-alertmanager": ["monitoring"],
        "prometheus-openstack-exporter": ["monitoring"],
        "prometheus-elasticsearch-exporter": ["elasticsearch"],
